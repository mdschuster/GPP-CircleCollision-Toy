## Circle Collision Toy
This is a toy program that illustrates circle-circle collision detection in 2D. It goes along with a lecture in Game Physics Programming taught
